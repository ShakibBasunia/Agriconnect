<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #6f42c1;">
  <a class="navbar-brand" href="#">Wholeseller Portal</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ms-auto">
      ...
      <li class="nav-item"><a class="nav-link" href="receive_product.php">Update Status</a></li>
      <li class="nav-item"><a class="nav-link" href="wholeseller_logout.php">Logout</a></li>
    </ul>
  </div>
</nav>
